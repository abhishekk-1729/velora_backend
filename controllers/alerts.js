...
const sendEmail = (req, res) => {
    ...
    const mailOptions = {
        ...
        subject: 'Welcome to Velora - Let’s Get Started!',  // Subject line with business context
        text: `Dear user,\n\nWe’re thrilled to have you on board with Velora!\nHere’s what you can expect as part of our community...\n\nBest Regards,\nVelora`,  // Plain text body (fallback)
        html: `
            <div style="font-family: Arial, sans-serif; font-size: 16px;">
                <p>Hello <strong>user</strong>,</p>
                <p>Welcome to <strong>Velora</strong>! We’re thrilled to have you on board and look forward to helping you achieve your goals with our services.</p>
                ...
                <p>If you have any questions, feel free to reach out to us at <a href="mailto:support@yourbusiness.com">support@yourbusiness.com</a>!</p>
                <p>Best Regards,<br/><strong>Velora</strong></p>
                <hr/>
                <p style="font-size: 12px; color: gray;">
                    This is an automated message. Please do not reply. If you need assistance, contact us at support@yourbusiness.com.
                </p>
            </div>
